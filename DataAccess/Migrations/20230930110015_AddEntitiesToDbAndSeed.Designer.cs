...
namespace DataAccess.Migrations
{
    ...
    [Migration("20230930110015_AddEntitiesToDbAndSeed")]
    partial class AddEntitiesToDbAndSeed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Models.Quiz", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            QuizID = new Guid("ea8b887f-042d-4c56-a034-68845aa34099"),
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 9, 30, 14, 0, 14, 852, DateTimeKind.Local).AddTicks(9097),
                            Name = "Havuz Soruları",
                            VisitLimit = 5
                        });
                });
